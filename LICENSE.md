...
Source code authored by the repository owner is provided for
non-commercial educational and personal use.

Commercial use of this source code requires prior permission from
the copyright holder.

## Third-Party Material

Challenge binaries, source code, assets, names, and other materials
created by third parties remain the property of their respective owners.

This repository's license does not grant additional rights to
third-party material.
